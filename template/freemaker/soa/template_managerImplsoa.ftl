...
import ${cfb.packageName}.manager.${mytagprizepackage1}.${tb.fUpperTName}ManagerSoa;

@Component("${tb.fLowerTName}Manager")
public class ${tb.fUpperTName}${cfb.fileNameSuffix} implements ${tb.fUpperTName}ManagerSoa{
	...
	public List<${tb.fUpperTName}> get${tb.fUpperTName}All(){
		return ${tb.fLowerTName}Dao.get${tb.fUpperTName}All();
	}
