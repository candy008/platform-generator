...
public class ${tb.fUpperTName}Action extends BaseAction<${tb.fUpperTName}>{
	...
	public void get${tb.fUpperTName}ByPage(){
		...
		Struts2Utils.renderJson(${tb.fLowerTName}PageListStr);
	}
	...
	public void get${tb.fUpperTName}All(){
		...
		String ${tb.fLowerTName}ListStr = JsonUtils.toJson(${tb.fLowerTName}List);
		Struts2Utils.renderJson(${tb.fLowerTName}ListStr);
	}
	...
	public void get${tb.fUpperTName}ById(){
		...
		Struts2Utils.renderJson(JsonUtils.toJson(${tb.fLowerTName}));
	}
