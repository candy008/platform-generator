...
public class ${tb.fUpperTName}${cfb.fileNameSuffix}{
	...
	public void insert${tb.fUpperTName}(){
		...
		${tb.fLowerTName}.set${item.fUpperColName}(new BigDecimal(1.15));
		<#else>
	...
	public void delete${tb.fUpperTName}ByCondition(){
		...
		<#elseif item.javaType=="BigDecimal">
		${tb.fLowerTName}Query.set${item.fUpperColName}(new BigDecimal(1.15));
		<#else>
	...
	public void update${tb.fUpperTName}ByCondition(){
		...
		<#elseif item.javaType=="BigDecimal">
		record.set${item.fUpperColName}(new BigDecimal(1.15));
		<#else>
		...
		<#elseif item.javaType=="BigDecimal">
		parameter.set${item.fUpperColName}(new BigDecimal(1.15));
		<#else>
