...
public class ${tb.fUpperTName}${cfb.fileNameSuffix}{
	...
	public void delete${tb.fUpperTName}ById(){
		${tb.fUpperTName} ${tb.fLowerTName} = new ${tb.fUpperTName}();
		//testDelete
		${tb.fLowerTName}Dao.delete${tb.fUpperTName}ById(${tb.fLowerTName}.getId());	
	}
	...
	public void get${tb.fUpperTName}ById(){
		${tb.fUpperTName} ${tb.fLowerTName} = new ${tb.fUpperTName}();
		//testGetById
		${tb.fLowerTName}Dao.get${tb.fUpperTName}ById(${tb.fLowerTName}.getId());
	}
	...
	public void get${tb.fUpperTName}All(){
		...
		//testGetAll
		${tb.fLowerTName}Dao.get${tb.fUpperTName}All(${tb.fLowerTName}Query);
	}
